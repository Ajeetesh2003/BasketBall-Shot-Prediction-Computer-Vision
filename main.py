        ...
        if posListX:
            ...
            for i, (posX, posY) in enumerate(zip(posListX, posListY)):
                ...
                if i == 0:
                    ...
                    cv2.line(imgResult, pos, (posListX[i - 1], posListY[i-1]), (0, 255, 0), 5)
            ...
            if prediction:
                cvzone.putTextRect(imgResult, "Basket", (50, 150),
                                   scale=5, thickness=5, colorR=(0, 200, 0), offset=20)
            else:
                cvzone.putTextRect(imgResult, "No Basket", (50, 150),
                                   scale=5, thickness=5, colorR=(0, 0, 200), offset=20)
        
        cv2.line(imgContours, (330, 593), (430, 593), (255, 0, 255), 10)
